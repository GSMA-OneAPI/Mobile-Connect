...
public class JsonUtils {
	...
	/**
	 * Convert JSON data to a Java object representing the JSON, uses the in-built Android libraries.
	 * 
	 * @param content
	 * @param contentType
	 * @return Object 
	 ...
	 */
	public static Object convertContent(String content, String contentType) throws JSONException {
	 ...
	 * @throws JSONException
	 */
	public static JSONObject readDiscoveryDataJSON(InputStream is) throws IOException, JSONException {
