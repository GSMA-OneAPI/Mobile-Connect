...
public class HttpUtils {
	 ...
	 * @return
	 */
	public static String getQueryParameterFromUrl(String url, String name) {
		String value=null;
			...
			try {
				...
				if (query!=null) {
					...
					if (kvpairs!=null && kvpairs.length>0) {
						for (int i=0; i<kvpairs.length && value==null; i++) {
							String[] kv=kvpairs[i].split("=", 2);
							if (kv!=null && kv.length==2 && kv[0].equalsIgnoreCase(name)) {
								value=kv[1];
							}
						}
					}
